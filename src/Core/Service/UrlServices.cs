...
public class UrlServices
{
	...
	{
		string redirectUrl = "https://www.amvcc.com";
		try
		{
			...
			{
				var tempUrl = new ShortUrlEntity(string.Empty, shortUrl.ToLowerInvariant());
	...
	public async Task<ShortResponse> Create(ShortRequest input, string host)
	{
		...
		try
		{
			...
			string vanity = string.IsNullOrWhiteSpace(input.Vanity) ? "" : input.Vanity.Trim().ToLowerInvariant();
